...
<nav>
    ...
    <a href="input.php"><b>FORMULIR</b></a>
    <a href="tampil0025.php" style="color: #2980b9;">LIHAT DATA</a>
</nav>
...
<div class="form-container">
    ...
    <form id="formPendaftaran" action="proses0025.php" method="post">
        ...
        <div class="checkbox-group">
            <label><input type="checkbox" required> Dengan ini menyatakan bahwa data yang diberikan benar</label>
        </div>
